                ...
                <div className="p-2">
                    <div className="text-gray-300 my-3">
                        ...
                        <p className="text-justify leading-7 w-11/12 mx-auto">
                            I'd love to connect! Whether you have a question, a project idea,
                            or just want to say hello, feel free to drop me a message below.
                        </p>     
                    </div>
                </div> 
...
{/* 
            ...
            className=' max-w-6xl p-5 md:p-12' id="form">
                ...
                <textarea
                    ...
                    className='mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4'
                />
                <button type="submit" className='w-full py-3 rounded-md text-gray-100 font-semibold text-xl bg-primary-color'>Let's Connect</button>
            </form>
